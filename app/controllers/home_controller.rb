class HomeController < ApplicationController
  def run_questionnaire
    ...
    #   answer_1.open_answer = params["answer_first"]
    #   answer_1.save!
    # elsif question_1.kind == "date"
    #   answer_1.date = params["answer_first"]
    #   answer_1.save!
    # else question_1.kind == "single_choice"
    #   answer_1.single_answer = params["answer_first"]
    #   answer_1.save!
    # end
    ...
    #   answer_2.open_answer = params["answer_second"]
    #   answer_2.save!
    # elsif question_2.kind == "date"
    #   answer_2.date = params["answer_second"]
    #   answer_2.save!
    # else question_2.kind == "single_choice"
    #   answer_2.single_answer = params["answer_second"]
    #   answer_2.save!
    # end
    ...
    #   answer_3.open_answer = params["answer_third"]
    #   answer_3.save!
    # elsif question_3.kind == "date"
    #   answer_3.date = params["answer_third"]
    #   answer_3.save!
    # else question_3.kind == "single_choice"
    #   answer_3.single_answer = params["answer_third"]
    #   answer_3.save!
    # end
    ...
    #   answer_4.open_answer = params["answer_fourth"]
    #   answer_4.save!
    # elsif question_1.kind == "date"
    #   answer_4.date = params["answer_fourth"]
    #   answer_4.save!
    # else question_1.kind == "single_choice"
    #   answer_4.single_answer = params["answer_fourth"]
    #   answer_4.save!
    # end
    ...
    #   answer_5.open_answer = params["answer_fifth"]
    #   answer_5.save!
    # elsif question_5.kind == "date"
    #   answer_5.date = params["answer_fifth"]
    #   answer_5.save!
    # else question_5.kind == "single_choice"
    #   answer_5.single_answer = params["answer_fifth"]
    #   answer_5.save!
    # end
    ...
    #   answer_6.open_answer = params["answer_sixth"]
    #   answer_6.save!
    # elsif question_6.kind == "date"
    #   answer_6.date = params["answer_sixth"]
    #   answer_6.save!
    # else question_6.kind == "single_choice"
    #   answer_6.single_answer = params["answer_sixth"]
    #   answer_6.save!
    # end
  end
end